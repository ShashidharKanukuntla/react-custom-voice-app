...
import { getTextAanlysisData, getTokenOrRefresh } from './token_util';
import './custom.css'
    ...
    async function sttFromMic() {
        ...
        recognizer.recognizeOnceAsync(async result => {
            if (result.reason === ResultReason.RecognizedSpeech) {
                ...
                const resp = await getTextAanlysisData(result.text);
                console.log('response: ', resp);
                setDisplayText(`Command Identified: ${resp.commandType}`);
            } else {
